...
{
    public sealed class UniformNoiseTests
    {
        [Property]
        public void GeneratesMapWithRightDimensions(int w, int h, int seed)
        {
            ...
            var map = UniformNoise.Generate(w, h, seed);
        ...
        {
            var map = UniformNoise.Generate(5, 5, seed);
        ...
        {
            var map1 = UniformNoise.Generate(5, 5, seed);
            var map2 = UniformNoise.Generate(5, 5, seed);
